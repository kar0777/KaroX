...
The canonical documented suite is now 3362 tests under:
...
- run the complete 3362-test suite, lint, typing, coverage and wheel smoke on
...
1. Publish `5.0.0rc1` as a pre-release wheel so the beta can install without a
   source checkout.
