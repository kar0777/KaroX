...
reported `Ran 1117 tests`.

1117 is also what the corresponding test collection under `tests` reports. The
repository root collects 1122 because it additionally finds five legacy KaroX 4
