...
For comparison with archived phase reports, the current unittest baseline contains 3525 cases. This is a discovery count, not a historical run result.

The unittest-plus-legacy subtotal is 3530: that baseline plus five legacy KaroX 4
