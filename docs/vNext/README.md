...
For comparison with archived phase reports, the current unittest baseline contains 3378 cases. This is a discovery count, not a historical run result.

The unittest-plus-legacy subtotal is 3383: that baseline plus five legacy KaroX 4
