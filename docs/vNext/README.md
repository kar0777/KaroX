...
reported `Ran 798 tests`.

790 is also what the corresponding test collection under `tests` reports. The
repository root collects 803 because it additionally finds five legacy KaroX 4
