...
reported `Ran 1123 tests`.

1123 is also what the corresponding test collection under `tests` reports. The
repository root collects 1128 because it additionally finds five legacy KaroX 4
