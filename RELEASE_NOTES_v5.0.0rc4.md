# 🚀 KaroX 5.0.0rc4 — Public Beta / Публичная бета
...
`5.0.0rc4` is the third public **KaroX 5 beta release candidate**. It carries the
...
`5.0.0rc4` — третий публичный **release candidate KaroX 5**: проверенный кандидат
...
- **Installability**: same one-command install as rc2
  (`pipx install "karox-runtime==5.0.0rc4"` or
