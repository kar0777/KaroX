...
подтверждения. Открой её, вручную введи текущий `OAuth approval password` и
повтори тот же вызов. Подтверждение привязано к точным аргументам, действует
один раз и не передаёт пароль модели или MCP-клиенту.
