...
count is maintained separately. The suite is 3379 tests.

```bash
python -m unittest discover -s tests -p "test_*.py"
```

A clean run reports `Ran 3379 tests`. Class-level environment skips can reduce
the executed count. The unittest-plus-legacy subtotal is 3384 (the baseline
