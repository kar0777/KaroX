...
count is maintained separately. The suite is 3558 tests.

```bash
python -m unittest discover -s tests -p "test_*.py"
```

A clean run reports `Ran 3558 tests`. Class-level environment skips can reduce
the executed count. The unittest-plus-legacy subtotal is 3563 (the baseline
