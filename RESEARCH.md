...
- Observe, Build, and Advanced access profiles, with durable session resume kept separate from permission level;
- protected API and MCP endpoints;
- repository path confinement and sensitive-file filtering;
- command restrictions plus exact, one-shot approval for remote Git push and prerelease publication;
